...
@router.message(F.text.in_([
    LEXICON["ru"]["btn_employer"], LEXICON["kk"]["btn_employer"], LEXICON["en"]["btn_employer"],
    LEXICON["ru"]["btn_seeker"], LEXICON["kk"]["btn_seeker"], LEXICON["en"]["btn_seeker"],
    LEXICON["ru"]["btn_my_vac"], LEXICON["kk"]["btn_my_vac"], LEXICON["en"]["btn_my_vac"]
]))
